...
BOARD_SUPER_PARTITION_GROUPS := sakura_dynamic_partitions
BOARD_SAKURA_DYNAMIC_PARTITIONS_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 4194304 )
BOARD_SAKURA_DYNAMIC_PARTITIONS_PARTITION_LIST := system vendor
